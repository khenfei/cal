...
public class AncestorLabel implements JSONStringEnable {
	...
	public String toJSON() {
		return new StringBuilder("{")
				.append("'ancestor':"+ancestor().toJSON())
				.append(",'requestor':"+requestor().toJSON())
				.append(",'number':"+number().toJSON())
				.append("}")
				.toString();
	}
	...
	public static class AncestorLabelBuilder {
		...
		public AncestorLabelBuilder ancestor(
				final String name) {
			this.ancestor = new Field(name);
			return this;
		}
		public AncestorLabelBuilder requestor(
				final String name) {
